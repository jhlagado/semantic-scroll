...
Working through those roughly fourteen kilobytes brought back details I hadn't thought about for decades. I could read the descriptions and trace the logic of a game I couldn't have recreated from memory. My willingness to settle for an uppercase transcription had faded: now I wanted to see the title appear as originally arranged, enter a command and explore the game again. In the next article, I'll take the recovered program into VICE, a Commodore emulator, and work on getting it to accept commands, display its text and produce sound.
